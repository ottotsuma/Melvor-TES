export const en = {
  ...
  mod_decreaseFlatDamageWhileTargetHasMaxHP: "Decrease damage while you are fully healed by +${value}",
  ...
  tes_decreaseFlatDamageWhileTargetHasMaxHP: "Decrease damage while you are fully healed by +${value}",
